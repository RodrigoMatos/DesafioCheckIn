package br.com.desafio.utils.model;
...
public final class ConvertType {
	...
	public static Boolean getBoolean(Object object) {
		if (object != null) {
			if ("1".equals(object.toString().trim()) || "true".equalsIgnoreCase(object.toString().trim())) {
				return true;
			}
		}
		return false;
	...
	public static Object getValue(Object entity, String atributo, Object valor) throws Exception {
