...
public final class ReflexaoUtils {
	...
	/**
	 * @param classe
	 *            - Classe que possui o método static que será executado.
	 * @param nomeMetodo
	 *            - Nome do método que será executado para a entidade.
	 * @param parametros
	 *            - Parâmetros que o metodo espera (Caso não exista, deve-se passar
	 *            null).
	...
	/**
	 * @param entidade
	 *            - Objeto que será invocado o metodo.
	 * @param nomeMetodo
	 *            - Nome do metodo que será executado para a entidade.
	 * @param parametros
	 *            - Parametros que o metodo espera (Caso não exista, deve-se passar
	 *            null).
	 * @return Retorna o retorno do metodo que será executado (Caso seja void irá
	 *         retornar null).
	 * @throws Exception
	...
	/**
	 * @param classe
	 *            - Classe irá obter os nomes dos metodos.
	 * @param iniciandoCom
	 *            - Filtro caso precise, irá obter somente os metodos que iniciem
	 *            com este filtro (Caso não precise, passar nulo).
	...
	/**
	 * @param entidade
	 *            - Entidade que irá obter o valor do atributo
	 * @param nomeAtributo
	 *            - Nome do atributo
	...
	/**
	 * @param atributo
	 *            - Nome do atributo de algum objeto
	...
	private static String obterSubClass(Class<?> classe, String propriedade)
